...
struct AppSettingTabs: View {
  ...
  var body: some View {
    VStack {
      ...
      TabButton(
        index: $index, targetIndex: 0, image: Image(systemName: "square.stack.3d.up.fill"),
        text: "Models"
      )
      #if os(macOS)
      ...
      TabButton(
        ...
        image: Image(systemName: "square.and.arrow.down.on.square.fill"), text: "Download"
      )
      .padding(.top, 15)
      ...
      TabButton(
        index: $index, targetIndex: 2, image: Image(systemName: "info.circle.fill"), text: "Info"
      )
      //            .padding(.bottom)
      #if os(macOS)
