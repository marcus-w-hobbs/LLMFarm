...
//load model
let ai = AI(
  _modelPath: "/Users/guinmoon/dev/alpaca_llama_etc/mobilevlm-3b.Q4_K_M.gguf", _chatName: "chat")
...
_ = ai.model.make_image_embed(
  "/Users/guinmoon/dev/alpaca_llama_etc/Angelina-Jolie-Rome-Film-Fest.jpg")
